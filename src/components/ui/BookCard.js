...
export default function BookCard({ book }) {
  ...
  return (
    <div className="glass-card rounded-xl overflow-hidden group hover:-translate-y-1 hover:shadow-2xl transition-all duration-300">
      {/* Book Cover */}
      ...
      <div className="p-6">
        ...
        {/* Button */}
        <button className="w-full flex items-center justify-center bg-linear-to-r from-[#dc2505] to-[#f6c438] text-white px-8 py-3 rounded-full text-xs md:text-sm font-bold tracking-[0.18em] hover:scale-[1.02] transition">
          Request to Buy
        </button>
      </div>
    </div>
